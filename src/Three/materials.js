...
simulationMaterial.blending = NoBlending;
...
/**
 ...
 the screen.
 */
export const displayMaterial = new ShaderMaterial({
    uniforms: displayUniforms,
    vertexShader: displayVertShader,
    fragmentShader: displayFragShader,
});
displayMaterial.blending = NoBlending;
